...
app.use((req, res, next) => {
  // More permissive CSP for development and compatibility
  res.setHeader(
    'Content-Security-Policy',
    "default-src 'self' 'unsafe-inline' 'unsafe-eval'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https:; style-src 'self' 'unsafe-inline' https:; font-src 'self' https:; img-src 'self' data: https: blob:; connect-src 'self' wss: https: ws:; frame-src 'self'; object-src 'none'; base-uri 'self'; form-action 'self';"
  )
  next()
})
