  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Container style={{ 
        ...
        <ContentWrapper>
          {/* Main Game Area - New Three Column Layout */}
          <div style={{ 
            display: 'grid', 
            gridTemplateColumns: '350px 1fr 300px', // Wider left box for players
            gap: '2rem', 
            marginBottom: '2rem',
            alignItems: 'start',
            minHeight: '500px'
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                <div style={{
                  background: gameState?.currentPlayer === gameData?.creator ? 
                    ...
                    'rgba(0, 0, 0, 0.2)',
                  border: gameState?.currentPlayer === gameData?.creator ? 
                    '2px solid #00BFFF' : 
                  ...
                  boxShadow: gameState?.currentPlayer === gameData?.creator ? 
                  ...
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{
                        color: gameState?.currentPlayer === gameData?.creator ? '#00BFFF' : '#FFD700',
                        fontWeight: 'bold',
                        fontSize: '1rem'
                      }}>
                      ...
                      {gameState?.creatorChoice && (
                        <div style={{
                          ...
                          Chose: {gameState.creatorChoice.toUpperCase()}
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    {Array.from({ length: gameState?.maxRounds || 5 }).map((_, index) => {
                      const roundNumber = index + 1
                      const isWon = roundNumber <= (gameState?.creatorWins || 0)
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            height: '1.5rem',
                            borderRadius: '50%',
                            background: isWon ? '#00FF41' : 
                                       isCurrent ? 'rgba(255, 215, 0, 0.3)' : 
                ...
                <div style={{
                  background: gameState?.currentPlayer === gameData?.joiner ? 
                    'linear-gradient(135deg, rgba(0, 191, 255, 0.2) 0%, rgba(0, 191, 255, 0.05) 100%)' : 
                    'rgba(0, 0, 0, 0.2)',
                  border: gameState?.currentPlayer === gameData?.joiner ? 
                    '2px solid #00BFFF' : 
                    '1px solid rgba(255, 255, 255, 0.1)',
                  borderRadius: '1rem',
                  padding: '1rem',
                  transition: 'all 0.3s ease',
                  boxShadow: gameState?.currentPlayer === gameData?.joiner ? 
                    '0 0 20px rgba(0, 191, 255, 0.3)' : 
                    'none'
                }}>
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{
                        color: gameState?.currentPlayer === gameData?.joiner ? '#00BFFF' : '#FFD700',
                        fontWeight: 'bold',
                        fontSize: '1rem'
                      }}>
                      ...
                      {gameState?.joinerChoice && (
                        <div style={{
                          ...
                          Chose: {gameState.joinerChoice.toUpperCase()}
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    {Array.from({ length: gameState?.maxRounds || 5 }).map((_, index) => {
                      const roundNumber = index + 1
                      const isWon = roundNumber <= (gameState?.joinerWins || 0)
                      const isCurrent = roundNumber === gameState?.currentRound
