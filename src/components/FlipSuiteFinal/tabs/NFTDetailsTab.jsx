      ...
      <NFTSection>
        ...
        <NFTInfo>
          <InfoRow>
            ...
            <InfoValue>{gameData.nft_name || 'Unknown NFT'}</InfoValue>
          </InfoRow>
          <InfoRow>
            <InfoLabel>Collection:</InfoLabel>
            <InfoValue>{gameData.nft_collection || 'Unknown Collection'}</InfoValue>
          </InfoRow>
          <InfoRow>
            <InfoLabel>Token ID:</InfoLabel>
            <InfoValue>#{gameData.nft_token_id || 'Unknown'}</InfoValue>
          </InfoRow>
          <InfoRow>
          ...
          <InfoRow>
            ...
            <InfoValue>{gameData.nft_chain || 'Unknown'}</InfoValue>
          </InfoRow>
        </NFTInfo>
        ...
        <SocialButtons>
          <SocialButton onClick={() => window.open(`https://opensea.io/assets/${gameData.nft_chain}/${gameData.nft_contract}/${gameData.nft_token_id}`, '_blank')}>
            🌊 OpenSea
          </SocialButton>
