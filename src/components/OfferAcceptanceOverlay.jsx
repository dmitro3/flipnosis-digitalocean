...
const OfferAcceptanceOverlay = ({ 
  ...
  console.log('🎯 OfferAcceptanceOverlay render:', { 
    ...
    gameDataPriceUsd: gameData?.price_usd,
    // Debug button condition
    isCreatorWaiting: acceptedOffer?.isCreatorWaiting,
    offererAddress: acceptedOffer?.offerer_address,
    currentAddress: address,
    addressesMatch: acceptedOffer?.offerer_address?.toLowerCase() === address?.toLowerCase(),
    shouldShowButton: !acceptedOffer?.isCreatorWaiting && acceptedOffer?.offerer_address?.toLowerCase() === address?.toLowerCase()
  })
