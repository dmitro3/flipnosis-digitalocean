        ...
        <ContentWrapper>
          ...
          <GlassCard style={{ 
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
              <NeonText style={{ color: '#FF4444', fontSize: '1.5rem' }}>
                🚨 Emergency NFT Recovery
              </NeonText>
              <Button
                onClick={() => setShowEmergencyRecovery(!showEmergencyRecovery)}
                style={{ 
                  background: '#FF4444', 
                  color: 'white',
                  padding: '0.5rem 1rem',
              ...
              >
                {showEmergencyRecovery ? 'Hide' : 'Show'} Recovery Tools
              </Button>
            </div>
            ...
            {showEmergencyRecovery && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {/* Find NFT Section */}
                <div>
                  <h4 style={{ color: '#FFD700', marginBottom: '0.5rem' }}>Find Your NFT</h4>
                ...
                {/* Find Games Section */}
                <div>
                  <h4 style={{ color: '#FFD700', marginBottom: '0.5rem' }}>Find Your Games</h4>
                  <Button
                    onClick={findMyGames}
                    disabled={!address}
                    style={{
                  ...
                  {myGames && (
                    <div>
                      ...
                      {myGames.myGames.length > 0 ? (
                        ...
                        <p style={{ color: 'white', fontSize: '0.9rem' }}>No games found for your address.</p>
                      )}
                    </div>
                  )}
                </div>
