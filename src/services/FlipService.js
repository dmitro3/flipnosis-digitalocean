/**
 * Server-Authoritative Flip Service
 * Implements commit-reveal mechanics for fair coin flipping
 * Based on the serverside.md specification
 */
...
class FlipService {
  ...
  generateSecureSeed() {
    ...
    // In browser, use crypto.getRandomValues (fallback)
  ...
  hashSeed(seed) {
    ...
    for (let i = 0; i < seed.length; i++) {
      hash = ((hash << 5) - hash + seed[i]) & 0xffffffff
    }
