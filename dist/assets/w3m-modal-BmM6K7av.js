import{h as pe,p as me,i as he,j as ve,M as g,S as ee,R as l,k as v,l as E,L as f,m as a,A as j,n as te,o as ie,C as m,q as H,u as fe,v as k,E as q,O as T,x as M,y as F,z as $,B as D,T as ge,D as be,F as ye,G as xe}from"./core-DSApd-48.js";import{c as u,p as d,s as w,i as V,U as Ce}from"./index-Bjd8qHnG.js";import"./index-B7qWZt8-.js";import"./events-CeDMxkB1.js";import"./index.es-Bqc6Hfus.js";const p=me({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(r){return ve(p,()=>r(p))},subscribeKey(r,e){return he(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
