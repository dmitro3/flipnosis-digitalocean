...
# Usage: .\deploy-ultra-simple.ps1 "Your commit message"
...
Write-Host "Starting ultra-simple deployment..." -ForegroundColor Green
...
# Deploy using a single command without line breaks
